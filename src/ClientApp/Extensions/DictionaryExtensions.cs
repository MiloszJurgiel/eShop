...
public static class DictionaryExtensions
{
    ...
    {
        return dictionary.TryGetValue(key, out var rawValue) && rawValue is bool dictValue
            ? dictValue
            : defaultValue;
    }
    ...
    {
        return dictionary.TryGetValue(key, out var rawValue) && rawValue is int intValue
            ? intValue
            : defaultValue;
    }
    ...
    {
        return dictionary.TryGetValue(key, out var rawValue) && rawValue is T value
            ? value
            : defaultValue;
    }
}
